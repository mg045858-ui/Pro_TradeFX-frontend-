...
const STEPS = [
  { n:"1", t:"Deposit Any Amount (Min. ₹830)",       d:"Fund instantly via card, UPI, e-wallet or crypto. Money appears live in seconds." },
...
export function ProfitSection({ onNavigate }) {
  ...
  const investINR = invest * USD_TO_INR;
  const profitINR = profit * USD_TO_INR;
      ...
      <div style={{ maxWidth:1200, margin:"0 auto", padding:"0 5%", position:"relative", zIndex:2 }}>
        ...
        <div className="hp-profit-grid" style={{
            ...
            <div style={{ position:"relative" }}>
              ...
              {STEPS.map(s => (
                <div key={s.n} style={{ display:"flex", gap:18, padding:"20px 0", position:"relative" }}>
                  ...
                  <div>
                    <div style={{ fontWeight:700, fontSize:".93rem", marginBottom:4 }}>
                      {s.t}
                    </div>

                    <div style={{ fontSize:".82rem", color:"rgba(195,200,220,.48)", lineHeight:1.75 }}>
                      {s.d}
                    </div>
                  </div>
          ...
          <div style={{
            ...
            <div style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:"1.45rem", fontWeight:800, marginBottom:4 }}>
              ⚡ Profit Calculator
            </div>

            <div style={{ fontSize:".78rem", color:"rgba(195,200,220,.48)", marginBottom:24, lineHeight:1.6 }}>
            ...
            <div style={{ display:"flex", justifyContent:"space-between", fontSize:".72rem", fontWeight:600, color:"rgba(195,200,220,.48)", marginBottom:7 }}>
              ...
              <span style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:".98rem", color:"#c8a84b" }}>
                ₹{investINR.toLocaleString()}
              </span>
            </div>
            ...
            <div style={{
              ...
              <div>
                <div style={{ fontSize:".69rem", color:"rgba(195,200,220,.48)", marginBottom:3 }}>
                  Your Profit
                </div>

                <div style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:"2.1rem", fontWeight:800, color:"#c8a84b", lineHeight:1 }}>
                  ₹{profitINR.toLocaleString()}
                </div>

                <div style={{ fontSize:".67rem", color:"#12e07a", fontWeight:600, marginTop:3 }}>
              ...
              <div style={{ textAlign:"right" }}>
                ...
                <div style={{ fontSize:".67rem", color:"rgba(195,200,220,.48)", marginTop:3 }}>
                  Capital + Profit
                </div>
              </div>
